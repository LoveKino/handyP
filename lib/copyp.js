...
var copyFile = function copyFile(src, tar, opts) {
    ...
    return regeneratorRuntime.async(function copyFile$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            ...
            case 7:
                context$1$0.next = 9;
                return regeneratorRuntime.awrap((0, _mkdirp2["default"])(_path2["default"].dirname(info.tarPath)));

            case 9:
                context$1$0.next = 11;
                return regeneratorRuntime.awrap(_fsp2["default"].writeFile(info.tarPath, info.source, "utf-8"));
...
var copyDir = function copyDir(src, tar, opts) {
    ...
    return regeneratorRuntime.async(function copyDir$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            ...
            case 4:
                context$1$0.next = 6;
                return regeneratorRuntime.awrap((0, _mkdirp2["default"])(info.tarPath));

            case 6:
                context$1$0.next = 8;
                return regeneratorRuntime.awrap(_fsp2["default"].readdir(info.srcPath));

            case 8:
                paths = context$1$0.sent;
                context$1$0.next = 11;
                return regeneratorRuntime.awrap(concur(info.srcPath, info.tarPath, paths, opts));
...
var concur = function concur(src, tar, paths, opts) {
    return new Promise(function (resolve, reject) {
        ...
        for (var i = 0; i < paths.length; i++) {
            ...
            copy(_src, _dst, opts).then(function () {
                counter++;
